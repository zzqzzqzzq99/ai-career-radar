...
当前版本仍是研究型 MVP：内置数据是人工采集、人工去重和人工核验的阶段性快照，没有后台实时抓取、固定时点自动发布或用户系统。无法在本期重新确认的历史岗位统一标记为“待复核”，投递前应再次打开原始来源。路线图见[独立公开部署与复刻指南](./独立公开部署与复刻指南.md)。
...
4. 只有本期重新打开公开来源并能确认招聘的岗位才标记为“在招”，无法确认时标记为“待复核”；
