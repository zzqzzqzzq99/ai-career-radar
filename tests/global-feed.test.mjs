...
test('does not publish generic HR or operations roles from an AI company',()=>{assert.deepEqual(extract({company:'x',type:'ashby'},{jobs:[{title:'HR Operations Manager',location:'China',isRemote:true,jobUrl:'https://example.com/hr'}]}),[]);});
